...
public class AlphaBetaReversePlayer extends CheckersPlayer implements GradedCheckersPlayer
{
	...
	public AlphaBetaReversePlayer(String name, int side)
	{ 
		super(name, side);
